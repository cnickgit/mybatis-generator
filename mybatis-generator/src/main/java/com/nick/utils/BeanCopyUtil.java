...
public class BeanCopyUtil extends BeanUtils {
    ...
    public static void copyNotNullIgnoreEmptyProperties(Object source, Object target, String[] ignoreProperties) throws BeansException {
        copyNotNullIgnoreEmptyProperties(source, target, null, ignoreProperties);
    }
    ...
    private static void copyNotNullIgnoreEmptyProperties(Object source, Object target, Class<?> editable, String[] ignoreProperties) throws BeansException {
        Assert.notNull(source, "Source must not be null");
        Assert.notNull(target, "Target must not be null");
